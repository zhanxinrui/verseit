<template>
    <div class="hero is-fullheight is-info register2" >
            <!-- Header -->
            <div class="hero-heading">
                <div class="section intro-section has-text-centered">
                    <a href="https://cssninja.io"><img class="top-logo" v-bind:src="iconsrc" alt="Brand"></a>
            ...
            <!-- Body -->
            <div class="hero-body" style="margin-top:0px !important; padding-top:0px !important;">
                <div class="container" style="margin-top:0px !important; padding-top:0px !important;">
                    <div class="columns" style="margin-top:0px !important; padding-top:0px !important;">
...
import register2 from "@/assets/image/register2.png";
